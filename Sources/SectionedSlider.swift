...
public class StyleKit : NSObject {
    ...
    public static func drawSlider(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 156, height: 400), resizing: ResizingBehavior = .aspectFill, factor: CGFloat = 0.0, sections: CGFloat = 10, palette: Palette = Palette()) {
